...
SMALL_EQ_STEPS      =int(100)# int(1000000)
# MID_EQ_STEPS renamed to follow SIM core naming standard
MID_EQ_STEPS        = int(100)
LONG_EQ_STEPS       = int(100) # for restraints used 10000000
SLOW_OUTPUT         = int(100) # for restraints used 1000
NORMAL_CALC         = int(10)

PRO_STEPS             = int(100)# int(500000)
PRO_FREE_ENERGY_STEPS = int(100)# int(500000)
FAST_OUTPUT           = int(10) # 2000
PRO_DHDL              = int(10)
FAST_CALC             = int(10)
